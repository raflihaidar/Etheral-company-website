...
export default class extends AbstractView {
  ...
  async getHtml() {
   ...
   <section class="about-us">
     ...
     <figure>
       <img src="/user/src/assets/about.jpg" alt="About us" />
     </figure>
   </section>
   <section class="services">
     <ul class="card-container">
       <li>
         ...
         <p class="card-details">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent rutrum,
           tortor quis pretium laoreet,</p>
       </li>
